...
export default function About() {
  return (
    <div>
      <h2>About</h2>
      <p>
        This tool is meant to help speed up the creation of frequently asked
        question (FAQ) JSON-LD schema.
      </p>
      <p>
      ...
      <p>
        You can read more about the FAQ schema in the documentation from{" "}
        <a
